...
To access the project, clone or download the respository through the terminal
...
* As if now, only the Food & Drink page is coded and styled. The others have files but are empty files. 
